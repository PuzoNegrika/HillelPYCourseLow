...
# Якщо в нас __speed (тобто __...) - вона стає засекречуваною, і до неї доступу не може бути
# print(my_car._speed()) # буде помилка, бо він не знає що таке __speed
...
# !!! Класи пишуться з великої букви
# __init__ - те, що запускається для створення об'єкту
#
