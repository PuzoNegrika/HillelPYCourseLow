...
# За допомогою якого методу з модуля random можна створити набір випадкових цілих чисел, які відрізняються один від одного на 1?
# random.randint
#Що буде виведено на екран для цього коду?
# number = 0
# while number <= 10:
#     number = number + 2
#     if number == 5:
