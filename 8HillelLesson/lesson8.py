...
# Множина (set) — зберігає лише унікальні елементи без пар.

# # Відповіді на питання:

# Як виглядає правильний спосіб оголошення OrderedDict в Python?
# ordered_dict = collections.OrderedDict()

# Що таке іменований кортеж (namedtuple) в Python?
# Тип структури даних

# Яке призначення Frozenset в Python?
# Заборона модифікації множини

# Як оголошуються функції в Python?
# def my_function(param1, param2):

# set() - це невпорядкована колекція унікальних, незмінних елементів, яка підтримує математичні операції, як-от об'єднання, перетин і різниця
# Вона використовується для видалення дублікатів, перевірки членства та виконання математичних операцій над множинами значно швидше, ніж зі списками
